...
*  - should return the initial state when given by unknown action, karena ada default yang di berikan oleh reducer shingga jika ada type: unknown kembalikan nilai initialState yaitu array (maybe)
